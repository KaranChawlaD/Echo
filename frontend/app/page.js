...
export default function Dashboard() {
  ...
  const handleSubmitRequest = async () => {
    ...
    try {
      ...
      if (response.ok && data.callId) {
        ...
        throw new Error(
          data.error || "Failed to initiate call - no call ID returned"
        );
      }
    } catch (error) {
    ...
    const checkStatus = async () => {
      try {
        ...
        const response = await fetch(
          `http://localhost:3002/api/call-status/${callId}`
        );
        const data = await response.json();
        ...
        if (response.ok) {
          if (data.status === "completed") {
            ...
            addDebugInfo(
              `Call still in progress (${data.status}), continuing to poll...`
            );
  ...
  const downloadTranscript = () => {
    ...
    a.href = url;
    a.download = `support-call-transcript-${
  ...
  async function generateAndDownloadAudio() {
    ...
    const ai = new GoogleGenAI({ apiKey: process.env.GEMINI_API_KEY }); // Fake apiKey for those wondering
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-3">
            ...
            <p className="text-lg text-[#03060f] max-w-2xl mx-auto">
              When asking for help feels difficult, let our AI agent speak for
              you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between items-center">
                    <label
                      htmlFor="helpRequest"
                      className="block text-lg font-medium text-[#03060f]"
                    >
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    disabled={
                      !helpRequest.trim() || isLoading || !phoneNumber.trim()
                    }
              ...
              <div className="text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    Our AI agent is currently speaking with your support person
                    on your behalf...
                  </p>
              ...
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Your support request has been communicated. The conversation
                    transcript is ready for download.
                  </p>
                </div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                  ...
                  <p className="text-green-700 mb-4">
                    Our AI agent successfully conveyed your request for help and
            ...
            {callStatus === "error" && (
              <div className="text-center space-y-6">
                ...
                <div className="text-red-500">
                  ...
                  <p className="text-gray-600 mb-4">
                    We encountered an issue while trying to make the support
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-red-700 text-left max-w-md mx-auto space-y-1">
                    ...
                    <li>
                      • Check the debug info above for specific error details
                    </li>
                  </ul>
                </div>
          ...
          <div className="mt-8 bg-white/50 backdrop-blur rounded-lg p-6 shadow-lg">
            <h3 className="text-lg text-center text-gray-800 mb-3">
              How it works
            </h3>
